...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/Rajeshsubramanian2022/IRIS_REPO/master/IRIS/prepared_data.csv')
features = tpot_data.drop('target', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['target'], random_state=None)

# Average CV score on the training set was: 0.9916666666666668
exported_pipeline = GradientBoostingClassifier(learning_rate=1.0, max_depth=4, max_features=0.05, min_samples_leaf=19, min_samples_split=13, n_estimators=100, subsample=0.7000000000000001)
...
encoder_location = ''
target_encoder_location = 'https://github.com/Rajeshsubramanian2022/IRIS_REPO/blob/master/IRIS/target_encoder.pkl?raw=true'
